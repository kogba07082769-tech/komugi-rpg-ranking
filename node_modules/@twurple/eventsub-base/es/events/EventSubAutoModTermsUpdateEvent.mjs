 ...
 */
let EventSubAutoModTermsUpdateEvent = class EventSubAutoModTermsUpdateEvent extends DataObject {
    /** @internal */
...
EventSubAutoModTermsUpdateEvent = __decorate([
    rtfm('eventsub-base', 'EventSubAutoModTermsUpdateEvent', 'broadcasterId')
], EventSubAutoModTermsUpdateEvent);
export { EventSubAutoModTermsUpdateEvent };
