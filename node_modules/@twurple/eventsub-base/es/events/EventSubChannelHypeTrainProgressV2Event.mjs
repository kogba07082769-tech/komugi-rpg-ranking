 ...
 */
let EventSubChannelHypeTrainProgressV2Event = class EventSubChannelHypeTrainProgressV2Event extends DataObject {
    /** @internal */
...
EventSubChannelHypeTrainProgressV2Event = __decorate([
    rtfm('eventsub-base', 'EventSubChannelHypeTrainProgressV2Event', 'broadcasterId')
], EventSubChannelHypeTrainProgressV2Event);
export { EventSubChannelHypeTrainProgressV2Event };
