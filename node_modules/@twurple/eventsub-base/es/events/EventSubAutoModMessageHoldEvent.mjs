 ...
 */
let EventSubAutoModMessageHoldEvent = class EventSubAutoModMessageHoldEvent extends DataObject {
    /** @internal */
...
__decorate([
    Enumerable(false)
], EventSubAutoModMessageHoldEvent.prototype, "_client", void 0);
EventSubAutoModMessageHoldEvent = __decorate([
    rtfm('eventsub-base', 'EventSubAutoModMessageHoldEvent', 'messageId')
], EventSubAutoModMessageHoldEvent);
export { EventSubAutoModMessageHoldEvent };
