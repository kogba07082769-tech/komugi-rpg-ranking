 ...
 */
let EventSubChannelChatUserMessageHoldEvent = class EventSubChannelChatUserMessageHoldEvent extends DataObject {
    /** @internal */
...
EventSubChannelChatUserMessageHoldEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatUserMessageHoldEvent', 'messageId')
], EventSubChannelChatUserMessageHoldEvent);
export { EventSubChannelChatUserMessageHoldEvent };
