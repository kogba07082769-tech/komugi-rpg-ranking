 ...
 */
let EventSubAutoModMessageHoldV2Event = class EventSubAutoModMessageHoldV2Event extends DataObject {
    /** @internal */
...
EventSubAutoModMessageHoldV2Event = __decorate([
    rtfm('eventsub-base', 'EventSubAutoModMessageHoldV2Event', 'messageId')
], EventSubAutoModMessageHoldV2Event);
export { EventSubAutoModMessageHoldV2Event };
