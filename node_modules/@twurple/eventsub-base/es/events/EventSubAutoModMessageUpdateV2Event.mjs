...
import { EventSubAutoModMessageAutoMod } from "./common/EventSubAutoModMessageAutoMod.mjs";
import { EventSubAutoModMessageBlockedTerm } from "./common/EventSubAutoModMessageBlockedTerm.mjs";
/**
 * An EventSub event representing a held chat message by AutoMod being resolved in a channel.
 */
let EventSubAutoModMessageUpdateV2Event = class EventSubAutoModMessageUpdateV2Event extends DataObject {
    /** @internal */
    ...
    get blockedTerms() {
        return this[rawDataSymbol].blocked_term
            ? this[rawDataSymbol].blocked_term.terms_found.map(term => new EventSubAutoModMessageBlockedTerm(term, this.messageText))
            : null;
    }
    /**
...
__decorate([
    Enumerable(false)
], EventSubAutoModMessageUpdateV2Event.prototype, "_client", void 0);
EventSubAutoModMessageUpdateV2Event = __decorate([
    rtfm('eventsub-base', 'EventSubAutoModMessageUpdateV2Event', 'messageId')
], EventSubAutoModMessageUpdateV2Event);
export { EventSubAutoModMessageUpdateV2Event };
