 ...
 */
let EventSubChannelUnbanRequestCreateEvent = class EventSubChannelUnbanRequestCreateEvent extends DataObject {
    /** @internal */
...
EventSubChannelUnbanRequestCreateEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelUnbanRequestCreateEvent', 'id')
