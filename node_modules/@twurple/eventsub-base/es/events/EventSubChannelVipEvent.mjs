 ...
 */
let EventSubChannelVipEvent = class EventSubChannelVipEvent extends DataObject {
    /** @internal */
...
__decorate([
    Enumerable(false)
], EventSubChannelVipEvent.prototype, "_client", void 0);
EventSubChannelVipEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelVipEvent', 'userId')
], EventSubChannelVipEvent);
export { EventSubChannelVipEvent };
