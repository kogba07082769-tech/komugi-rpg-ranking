 ...
 */
let EventSubChannelChatSharedChatResubNotificationEvent = class EventSubChannelChatSharedChatResubNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    constructor() {
        super(...arguments);
    ...
    get streakMonths() {
        var _a;
        return (_a = this[rawDataSymbol].shared_chat_resub.streak_months) !== null && _a !== void 0 ? _a : null;
    }
    /**
    ...
    get isGifterAnonymous() {
        var _a;
        return (_a = this[rawDataSymbol].shared_chat_resub.gifter_is_anonymous) !== null && _a !== void 0 ? _a : null;
    }
    /**
     ...
     */
    async getGifter() {
        return await mapNullable(this[rawDataSymbol].shared_chat_resub.gifter_user_id, async (id) => await this._client.users.getUserById(id));
    }
};
EventSubChannelChatSharedChatResubNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSharedChatResubNotificationEvent', 'broadcasterId')
], EventSubChannelChatSharedChatResubNotificationEvent);
export { EventSubChannelChatSharedChatResubNotificationEvent };
