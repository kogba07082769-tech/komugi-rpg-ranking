 ...
 * session.
 */
let EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent = class EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    constructor() {
        super(...arguments);
        this.type = 'shared_chat_community_sub_gift';
    }
    /**
...
EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent', 'broadcasterId')
], EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent);
export { EventSubChannelChatSharedChatCommunitySubGiftNotificationEvent };
