...
let EventSubChannelChatBaseNotificationEvent = class EventSubChannelChatBaseNotificationEvent extends DataObject {
    ...
    getSourceBadgeInfo(name) {
        var _a, _b, _c;
        return (_c = (_b = (_a = this[rawDataSymbol].source_badges) === null || _a === void 0 ? void 0 : _a.find(badge => badge.set_id === name)) === null || _b === void 0 ? void 0 : _b.info) !== null && _c !== void 0 ? _c : null;
    }
};
__decorate([
    Enumerable(false)
