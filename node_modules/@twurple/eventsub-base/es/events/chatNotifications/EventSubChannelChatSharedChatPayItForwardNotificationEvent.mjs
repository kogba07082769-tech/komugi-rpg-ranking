 ...
 * chat session.
 */
let EventSubChannelChatSharedChatPayItForwardNotificationEvent = class EventSubChannelChatSharedChatPayItForwardNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    constructor() {
        super(...arguments);
     ...
     */
    async getGifter() {
        return await mapNullable(this[rawDataSymbol].shared_chat_pay_it_forward.gifter_user_id, async (id) => await this._client.users.getUserById(id));
    }
};
EventSubChannelChatSharedChatPayItForwardNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSharedChatPayItForwardNotificationEvent', 'broadcasterId')
