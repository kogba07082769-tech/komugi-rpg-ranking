 ...
 */
let EventSubChannelChatSharedChatRaidNotificationEvent = class EventSubChannelChatSharedChatRaidNotificationEvent extends EventSubChannelChatBaseNotificationEvent {
    constructor() {
        super(...arguments);
     ...
     */
    async getRaider() {
        return checkRelationAssertion(await this._client.users.getUserById(this[rawDataSymbol].shared_chat_raid.user_id));
    }
    /**
...
EventSubChannelChatSharedChatRaidNotificationEvent = __decorate([
    rtfm('eventsub-base', 'EventSubChannelChatSharedChatRaidNotificationEvent', 'broadcasterId')
], EventSubChannelChatSharedChatRaidNotificationEvent);
export { EventSubChannelChatSharedChatRaidNotificationEvent };
