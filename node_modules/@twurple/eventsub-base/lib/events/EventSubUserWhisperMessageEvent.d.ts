 ...
 */
export declare class EventSubUserWhisperMessageEvent extends DataObject<EventSubUserWhisperMessageEventData> {
    /**
     ...
     */
    getSenderUser(): Promise<HelixUser>;
    /**
     * The text of the whisper message.
     */
    get messageText(): string;
}
//# sourceMappingURL=EventSubUserWhisperMessageEvent.d.ts.map