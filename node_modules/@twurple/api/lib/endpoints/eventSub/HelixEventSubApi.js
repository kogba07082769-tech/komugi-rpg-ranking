...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi_1.BaseApi {
    ...
    async subscribeToChannelAutomaticRewardRedemptionAddV2Events(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_automatic_reward_redemption.add', '2', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:redemptions', 'channel:manage:redemptions']);
    }
    /**
    ...
    async subscribeToChannelHypeTrainBeginV2Events(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.begin', '2', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:hype_train']);
    }
    /**
     * Subscribe to events that represent progress towards the Hype Train goal.
     *
    ...
    async subscribeToChannelHypeTrainProgressV2Events(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.progress', '2', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:hype_train']);
    }
    /**
     * Subscribe to events that represent the end of a Hype Train event.
     *
    ...
    async subscribeToChannelHypeTrainEndV2Events(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.end', '2', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcaster), transport, broadcaster, ['channel:read:hype_train']);
    }
    /**
    ...
    async subscribeToChannelBitsUseEvents(broadcaster, transport) {
        const broadcasterId = (0, common_1.extractUserId)(broadcaster);
        return await this.createSubscription('channel.bits.use', '1', (0, eventSub_external_1.createEventSubBroadcasterCondition)(broadcasterId), transport, broadcasterId, ['bits:read']);
    }
    /**
