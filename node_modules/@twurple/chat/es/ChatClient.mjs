...
let ChatClient = ChatClient_1 = class ChatClient extends EventEmitter {
    ...
    constructor(config = {}) {
        ...
        this._ircClient.onDisconnect((manually, reason) => {
            var _a, _b, _c, _d;
            (_a = this._messageRateLimiter) === null || _a === void 0 ? void 0 : _a.clear();
            (_b = this._messageRateLimiter) === null || _b === void 0 ? void 0 : _b.pause();
            (_c = this._joinRateLimiter) === null || _c === void 0 ? void 0 : _c.clear();
            (_d = this._joinRateLimiter) === null || _d === void 0 ? void 0 : _d.pause();
        ...
        this._isAlwaysMod = (_f = config.isAlwaysMod) !== null && _f !== void 0 ? _f : false;
        this._botLevel = (_g = config.botLevel) !== null && _g !== void 0 ? _g : 'none';
        ...
        this._ircClient.onRegister(async () => {
            var _a, _b;
            (_a = this._messageRateLimiter) === null || _a === void 0 ? void 0 : _a.resume();
            (_b = this._joinRateLimiter) === null || _b === void 0 ? void 0 : _b.resume();
    ...
    quit() {
        var _a, _b, _c, _d;
        (_b = (_a = this._messageRateLimiter) === null || _a === void 0 ? void 0 : _a.destroy) === null || _b === void 0 ? void 0 : _b.call(_a);
        (_d = (_c = this._joinRateLimiter) === null || _c === void 0 ? void 0 : _c.destroy) === null || _d === void 0 ? void 0 : _d.call(_c);
